...
public interface Errors {
    ...
    DiagnosticFactory1<PsiElement, String> INVALID_SCRIPT_ENVIRONMENT_PROPERTY_NAME = DiagnosticFactory1.create(ERROR);
    DiagnosticFactory1<PsiElement, String> NON_UNIQUE_SCRIPT_ENVIRONMENT_PROPERTY_NAME = DiagnosticFactory1.create(ERROR);
